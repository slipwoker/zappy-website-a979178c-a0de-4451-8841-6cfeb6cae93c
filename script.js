...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'a979178c-a0de-4451-8841-6cfeb6cae93c',
                name: data.name || '',
                email: data.email || '',
      ...
      alert('תודה על ההרשמה! נחזור אליך בהקדם.');
      contactForm.reset();
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "NewTaxi Delivery משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
